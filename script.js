...
function playRound(humanChoice, computerChoice) {
    ...
    // TO DO: CONSOLE.LOG THE COMPUTER'S MOVE, OR SIMILAR TO YOU PLAYED XXX, AND COMPUTER PLAYED XXX, XXX BEATS XXX? TO MAKE TESTING EASIER THEN TEST ALL POSSIBLE OUTCOMES FROM ABOVE
